    ...
    rm -rf /home/ubuntu/${project_name}/api/dist
    rm -rf /home/ubuntu/${project_name}/web/dist
    ...
    # --- Asegurar permisos del frontend para nginx ---
    chmod -R o+rX dist
    ...
    # --- Asegurar permisos para ubuntu y nginx ---
    chown -R ubuntu:ubuntu /home/ubuntu/${project_name}

    # Permitir lectura y traversal a nginx (www-data)
    chmod -R o+rX /home/ubuntu/${project_name}

    # Reiniciar nginx para refrescar workers/permisos
    systemctl restart nginx
